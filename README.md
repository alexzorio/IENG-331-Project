...
ABC.sql is one of the suggested queries that classifies inventory into A/B/C tiers using the pareto principle. I chose this query to undertand which products are the money makers for the company and therefore require more attention. We made sure to take into acount the percenteage of total revenue that was taken up by each product. The revenue of each product was added together then divided by the grand total to find the percentage. Once that was done the products that made up 80% of the revenue was given the A tier, the next 15% was the B tier and the rest were put into C. 
